...
return static function (Router $router, Container $container): void {
    ...
    $router->get('/api/v1/partner/team', [PartnerController::class, 'team'], ['cors', 'auth', 'role:partner_owner']);
    $router->post('/api/v1/partner/team', [PartnerController::class, 'createTeamMember'], ['cors', 'auth', 'json', 'role:partner_owner']);
    $router->put('/api/v1/partner/team/{member_id}', [PartnerController::class, 'updateTeamMember'], ['cors', 'auth', 'json', 'role:partner_owner']);
    $router->put('/api/v1/partner/team/{member_id}/status', [PartnerController::class, 'updateTeamMemberStatus'], ['cors', 'auth', 'json', 'role:partner_owner']);
    $router->get('/api/v1/partner/dashboard', [PartnerOperationsController::class, 'dashboard'], ['cors', 'auth', 'role:partner_owner']);
    $router->get('/api/v1/partner/finance/summary', [PartnerOperationsController::class, 'finance'], ['cors', 'auth', 'role:partner_owner']);
    ...
    $router->get('/api/v1/partner/support', [PartnerOperationsController::class, 'support'], ['cors', 'auth', 'role:partner_owner']);
    $router->get('/api/v1/partner/support/{ticket_id}', [PartnerOperationsController::class, 'supportThread'], ['cors', 'auth', 'role:partner_owner']);
    $router->post('/api/v1/partner/support/tickets', [PartnerOperationsController::class, 'createSupportTicket'], ['cors', 'auth', 'json', 'role:partner_owner']);
    $router->post('/api/v1/partner/support/{ticket_id}/messages', [PartnerOperationsController::class, 'replySupportThread'], ['cors', 'auth', 'json', 'role:partner_owner']);
    $router->get('/api/v1/partner/notifications', [PartnerOperationsController::class, 'notifications'], ['cors', 'auth', 'role:partner_owner']);
    $router->post('/api/v1/partner/notifications/{notification_id}/read', [PartnerOperationsController::class, 'markNotificationRead'], ['cors', 'auth', 'role:partner_owner']);
